...
With the oxd-https-extension running, you can host your oxd-server on a dedicated machine, enabling all your apps to call your central oxd service over the web using `https`. 
